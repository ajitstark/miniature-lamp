  ...
  test("POST /assignments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateAssigned: CREATE_RESULT.dateAssigned.toISOString(),
      ...
      .expect([
        {
          ...
          dateAssigned: FIND_MANY_RESULT[0].dateAssigned.toISOString(),
  ...
  test("GET /assignments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateAssigned: FIND_ONE_RESULT.dateAssigned.toISOString(),
